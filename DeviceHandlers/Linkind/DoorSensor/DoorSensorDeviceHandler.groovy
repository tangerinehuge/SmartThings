...
metadata {
	definition(name: "Linkind Open/Closed Sensor", namespace: "galen", author: "Galen", runLocally: true, minHubCoreVersion: '000.017.0012', executeCommandsLocally: false, genericHandler: "Zigbee") {
		capability "Battery"
